...
const Aboutus = () => {
    ...
    return (
        <>
            <div className="main my-5 border border-gray-600 rounded-lg px-3">

                {/* columns start */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-6 gap-x-3">
                    <div className='left'>
                        <h3 className='text-5xl font-semibold capitalize '>About Us</h3>
                        <button className='bg-black text-white rounded-lg py-2 my-2 px-7 font-semibold capitalize'>learn more</button>
                        <Image src={'/assets/about_right.webp'} width={400} height={400} className='rounded-lg md:w-[80%] w-full h-[20rem] mt-4' />
                    </div>
