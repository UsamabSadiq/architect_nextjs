            ...
            <div className="grid grid-cols-1 md:grid-cols-2 px-3 mt-5 border-t border-slate-300">
                <div className="left sm:w-fit lg:min-w-[25rem] mt-4 font-orbitron ">
                    ...
                    <div className="only-for-sm-devices  md:flex sm:flex-col justify-between ">
                        <div className="email md:mt-16 border-2 rounded-lg py-2 pl-2" data-aos="fade-left">
                            <p className='text-base font-medium  '>Email Address</p>
                            <p className='text-xl font-semibold'>contact@mosaic.com</p>
                        </div>

                        <div className="numbers border-2 rounded-lg md:mt-14 md:mb-4 pb-5 pl-2" data-aos="fade-left">
                ...
                <div className="right">
                    <div className="text my-3 flex gap-5 flex-col items-center md:items-end"> {/* flex */}
                        ...
                        <div className="border px-2 py-1 rounded-lg flex  items-center gap-4 md:max-w-[25rem]" data-aos="fade-right">  {/* flex */}
                        ...
                        <Image src={'/assets/footer_location.webp'} alt='map' width={1000} height={500} className=' border rounded-lg h-[80%]' data-aos="zoom-out" />
