...
const Footer = () => {
    return (
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 px-3 mt-5 border-t border-slate-300">
                ...
                <div className="right">
                    <div className="text my-3 flex gap-5 flex-col items-center md:items-end"> {/* flex */}
                        <p className='text-sm md:text-xs text-justify text-slate-400'>Lorem, ipsum dolor sit amet consectetur <br /> adipisicing elit. Nesciunt minus <br /> at harum quis Nesciunt quis.</p>
                        <div className="border px-2 py-1 rounded-lg flex  items-center gap-4 md:max-w-[25rem]">  {/* flex */}
                            <Image src={'/assets/banner_image.PNG'} width={70} height={70} />
                            <div className="contact">
                                <p className='text-base font-medium capitalize'>say hi!</p>
                                <p className='text-lg font-semibold mt-1'>+090078601449</p>
                            </div>
                        </div>
                        <Image src={'/assets/footer_location.webp'} width={1000} height={500} className=' border rounded-lg h-[80%]' />
            ...
            <div className="main border-2 rounded-xl mt-5 min-h-44 ">
                {/* upperBottom starts  */}

                <div className="content grid grid-cols-1 md:grid-cols-2 px-3 pt-2">
                    <div className='w-1/2'>
                        <Image src={"/assets/logo.png"} width={70} height={70} />
                ...
                <div className="veryBottom flex flex-col items-center md:flex-row md:justify-between  mt-14 px-3 mb-2">
