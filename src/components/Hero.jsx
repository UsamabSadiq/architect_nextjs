            ...
            <div className="main my-5">
                <div className="flex flex-col md:flex-row gap-6 border-2 border-gray-300 rounded-md px-3">
                    ...
                    <div className="right w-full flex flex-col items-center gap-6 pt-2 pb-4 ">
                        ...
                        <button className='bg-black text-white rounded-lg py-2 my-4 px-10 font-semibold capitalize hover:bg-white hover:text-black hover:border hover:border-black '>let's go</button>
                        <Image src={'/assets/banner3.1_slider.avif'} width={800} height={800} className='rounded-lg' />
                    </div>
                </div>
            </div>
        </>
